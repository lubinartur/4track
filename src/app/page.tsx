    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto max-w-md min-h-screen px-4 pt-safe-area-inset-top pb-32">
        <div className="relative rounded-[36px] bg-[#0b0b0f]/30 p-6 pt-8 shadow-[inset_0_0_80px_rgba(0,0,0,0.4),inset_0_1px_0_rgba(255,255,255,0.02)] backdrop-blur-[0.5px]">
          ...
          <div className="mb-12">
            <div className="mb-3">
              <h2 className="text-[18px] font-medium uppercase tracking-[0.08em] text-primary">
                Films
              </h2>
            </div>
            ...
            {/* Curated for you */}
            <div className="mb-12">
              <h3 className="mb-5 text-[18px] font-medium uppercase tracking-[0.08em] text-primary">
                Curated for you
              </h3>
              {lifePick.safePick ? (
                <Link href={`/item/${lifePick.safePick.id}`}>
                  <div className="relative rounded-[20px] border border-white/5 bg-[#141420]/50 overflow-hidden shadow-[inset_0_1px_2px_0_rgba(255,255,255,0.08)] backdrop-blur-sm">
                    ...
                    {/* Content */}
                    <div className="p-5">
                      <h4 className="mb-2 text-[18px] font-medium text-primary line-clamp-1">
                ...
                <div className="rounded-[20px] border border-white/5 bg-[#141420]/50 p-6 text-center">
                  <h4 className="mb-2 text-[15px] font-medium text-primary">We're learning your taste</h4>
            ...
            <div className="mb-12">
              <div className="mb-3 flex items-center justify-between">
                <h3 className="text-[12px] font-medium uppercase tracking-[0.08em] text-white/70">
                  Up Next
                </h3>
            ...
            <div>
              <div className="mb-3 flex items-center justify-between">
                <h3 className="text-[12px] font-medium uppercase tracking-[0.08em] text-white/50">
                  Recently watched
                </h3>
          ...
          {/* Series Placeholder */}
          <PlaceholderSection title="Series" />

          {/* Anime Placeholder */}
          <PlaceholderSection title="Anime" />

          {/* Books Placeholder */}
          <PlaceholderSection title="Books" />
        </div>
      </div>
    </div>
  );
